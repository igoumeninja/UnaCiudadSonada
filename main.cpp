...
int main( ){
	...
	ofSetupOpenGL(&window, 3840, 1024, OF_WINDOW);	//3840, 1024
	//ofSetupOpenGL(&window, 300, 300, OF_WINDOW);			// <-------- setup the GL context  1920x1080	//ofSetupOpenGL(&window, 1920, 1080, OF_WINDOW);			// projector
